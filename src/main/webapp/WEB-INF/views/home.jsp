...
<c:otherwise>
<span style="color:red">Panel oficera, aby przeglądać zasoby musisz się najpierw zalogować.</span>
  <ul id="promobox">

    <li class="two">
    <ul>
<li><a href="registerForm.html">Zarejestruj się</a></li>
<li><a href="logonForm.html">Zaloguj</a></li>
</ul>
